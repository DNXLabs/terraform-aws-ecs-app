...
|------|-------------|------|---------|:--------:|
| alarm\_ecs\_running\_tasks\_threshold | Alarm when the number of ecs service running tasks is lower than a certain value (use 0 to disable this alarm) | `number` | `1` | no |
